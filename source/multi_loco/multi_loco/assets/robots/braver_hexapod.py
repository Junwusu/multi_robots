...
# Urdf file cfg
BRAVER_hexapod_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        fix_base=False,
        replace_cylinders_with_capsules=True,
        asset_path=f"{BRAVERLAB_ASSET_DIR}/resources/urdf/braver_hexapod.urdf",
    ...
    actuators={
        "motor": DelayedPDActuatorCfg(
            ...
            velocity_limit={
                ...
                "ML_abad_joint": 1000.0,
                "ML_hip_joint": 1000.0,
                "ML_knee_joint": 1000.0,
                "MR_abad_joint": 1000.0,
                "MR_hip_joint": 1000.0,
                "MR_knee_joint": 1000.0,
...
BRAVER_HEXAPOD_PRESERVE_JOINT_ORDER_ASSET_CFG = SceneEntityCfg(
    "hexapod",
    joint_names=[
        'FL_abad_joint', 
        'FL_hip_joint', 
...
# link definitions
BRAVER_HEXAPOD_BASE_NAME = "trunk",
BRAVER_HEXAPOD_FOOT_NAMES = ".*_foot"
BRAVER_HEXAPOD_UNDESIRED_CONTACTS_NAMES = ["trunk",
    "FL_Abad_Link",
    "FL_hip_Link",
    "FL_knee_Link",
    "FR_Abad_Link",
